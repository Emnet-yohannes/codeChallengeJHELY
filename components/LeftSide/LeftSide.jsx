...
const LeftSide = () => {
  ...
  return (
    <div className="bg-[#0D0D0D] opacity-50 w-[340px] md:w-[591px]">
      <div
        id="accordion0"
        className="cursor-pointer flex justify-between px-[15px] py-[26px]"
      >
      ...
      {accordionState ? (
        <div className="pb-[53px]  w-[200px]  h-[290px] md:w-[591px] md:h-[344px] ">
          ...
          <div className="grid grid-rows-2 grid-flow-col gap-y-[19px] gap-x-[2px] ">
            <div className="flex justify-start pl-8">
              ...
              <h1 className="text-[#FC364C] pl-4">Lorem ipsum</h1>
            </div>
            <div className="flex justify-start pl-8">
              <div className="w-5 h-5">
            ...
            <div className="flex justify-start">
              ...
              <h1 className="text-[#fff] pl-4">Lorem ipsum</h1>
            </div>
          </div>
        </div>
      ) : null}
